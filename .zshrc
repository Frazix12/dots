...
export PATH=/home/irfan/.nimble/bin:$PATH

eval "$(/home/linuxbrew/.linuxbrew/bin/brew shellenv)"source /usr/share/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh

if [ -e /home/irfan/.nix-profile/etc/profile.d/nix.sh ]; then . /home/irfan/.nix-profile/etc/profile.d/nix.sh; fi # added by Nix installer
